    ...
    if (isFileExtensionValid === true) {
      this.store
        ...
        .then(({ fileUrl, key }) => {
          ...
          this.document.getElementById('alert-send-bill').style.display = "none"
        }).catch(error => console.error(error))
    } else {
      this.document.getElementById('btn-send-bill').type = "button"
      this.document.getElementById('alert-send-bill').style.display = "block"
